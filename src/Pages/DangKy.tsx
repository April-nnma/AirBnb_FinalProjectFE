...
const DangKy = (props: Props) => {
    ...
    const registerMik = useFormik<formRegister>({
        ...
        validationSchema: yup.object().shape({
            ...
            password: yup
                .string()
                .required("Không để được trống mật khẩu!")
                .min(5, "Mât khẩu phải ít nhất 5 ký tự")
                .max(15, "Mật khẩu không được dài quá 8 ký tự"),
                ...
                <div className="relative font-medium md:h-screen flex items-center content-center w-full">
                    <div className="mr-auto ml-auto w-full">
                     ...
                     dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                ...
                                                onChange={
                                                    registerMik.handleChange
                                                }
                                                value={registerMik.values.name}
                                            />
                                        </div>
                                        <div className="mb-3">
                                            <label
                     ...
                     dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                ...
                                                value={registerMik.values.phone}
                                            />
                                        </div>
                                        <div className="mb-3">
                                            <label
                     ...
                     dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                ...
                                                value={registerMik.values.email}
                                            />
                                        </div>
                                        <div className="mb-3">
                                            <label
                     ...
                     dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div className="mb-6 text-center">
                                    <button
                                        type="submit"
                                        className="bg-red-500 hover:bg-red-800 shadow-lg text-white font-semibold text-sm py-3 px-0 rounded-full text-center w-80 hover:bg-tertiary duration-200 transition-all"
                                    >
                                        Đăng Ký
                                    </button>
                                </div>
